...
import { CertificateMeta, LogStringReturn, LogClassReturn, LogNumReturn, LogLongReturn } from "./templates/unidbg.js";
...
export function configShowCacheLog(isshow: boolean) {
    show_cache_log = isshow
}
